...
export default function NewSouthWales() {
  return (
    <>
    <div className=" bg-gray-50 mt-18">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-3">
          <span className="text-gray-900 font-semibold text-sm">New South Wales</span>
          <span className="text-gray-700">|</span>
          <span className="text-gray-700 text-sm">Commonwealth Migration Act 1958</span>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-6">
          Converting to a New South Wales licence
        </h1>
        ...
        <p className="text-gray-900 text-base mb-12 leading-relaxed">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-5">
            ...
            <div className="flex-grow">
              <div className="bg-white rounded-lg shadow border border-yellow-300 overflow-hidden hover:shadow-md transition-shadow">
                <div className="p-6">
