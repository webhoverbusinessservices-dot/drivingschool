                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
                        <div className="lg:col-span-6 bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-soft card-hoverable flex flex-col justify-between border-t-4 border-gray-200 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                    <p className="text-sm text-gray-500 uppercase font-bold tracking-wide dark:text-gray-50">Standard</p>
                                    <div className="flex items-baseline gap-1 mt-1">
                                        <span className="text-2xl font-bold text-gray-900 dark:text-white">$70</span>
                                        <span className="text-sm text-gray-500 dark:text-gray-50">/ 60min</span>
                                    </div>
                                </div>
                                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                    <p className="text-sm text-gray-500 uppercase font-bold tracking-wide dark:text-gray-50">Extended</p>
                                    <div className="flex items-baseline gap-1 mt-1">
                                        <span className="text-2xl font-bold text-gray-900 dark:text-white">$100</span>
                                        <span className="text-sm text-gray-500 dark:text-gray-50">/ 90min</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-5 bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-soft card-hoverable">
                            ...
                            <div className="flex justify-between items-center bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl">
                                <span className="text-base font-medium text-gray-600 dark:text-gray-50">Single Lesson</span>
                                <span className="text-2xl font-bold text-gray-900 dark:text-gray-50">$90</span>
                            </div>
                            <div className="mt-4 flex gap-2 flex-wrap">
                                <span className="text-sm bg-gray-100 dark:bg-gray-700 text-gray-500 px-2 py-1 rounded dark:text-gray-50">Merging</span>
                                <span className="text-sm bg-gray-100 dark:bg-gray-700 text-gray-500 px-2 py-1 rounded dark:text-gray-50">Lane Discipline</span>
                            </div>
                        </div>
