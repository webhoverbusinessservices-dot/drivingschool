    ...
    <>
      ...
      <section className="w-full bg-white flex items-center justify-center px-6 py-24">
        <div className="max-w-6xl w-full grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-6 lg:col-start-4 bg-white p-8 md:p-10 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.1)]">
            ...
            <p className="text-sm text-gray-600 mb-6 text-center">
              ...
              If it doesn’t arrive soon, check your spam or junk folder.
            </p>

            <form className="space-y-5" autoComplete="off" onSubmit={handleSubmit}>
              {/* Fake fields to block Chrome autofill */}
