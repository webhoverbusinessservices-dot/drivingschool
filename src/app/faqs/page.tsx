...
export default function Faqs() {
  ...
  return (
    <>
      ...
      <section className="faq-section-hero relative py-15 overflow-hidden bg-gradient-to-br from-amber-50 via-white to-orange-50">
        {/* Animated road lines */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="">
            {/* FAQ Column */}
            <div className="space-y-4 lg:col-span-12 lg:col-start-2 mx-auto w-full">
              {faqs.map((item, index) => (
                <div
                  key={index}
                  className="group bg-white border-y border-gray-300 overflow-hidden hover:border-yellow-300 transition-all duration-300 hover:shadow-xl"
                >
                  <button
                    className="w-full flex justify-between items-center p-3 text-left"
                    onClick={() => toggleFaq(index)}
                  >
                    <span className="font-semibold text-gray-900 text-sm md:text-base pr-4 group-hover:text-yellow-700 transition-colors">
                      {item.question}
                    </span>
                    <div
